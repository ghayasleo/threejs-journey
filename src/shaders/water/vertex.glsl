...
void main() {
    ...
    float elevation = sin(modelPosition.x * uBigWaveFrequency.x+ uTime * uBigWaveSpeed) * sin(modelPosition.z * uBigWaveFrequency.y+ uTime * uBigWaveSpeed) * uBigWaveElevation;
